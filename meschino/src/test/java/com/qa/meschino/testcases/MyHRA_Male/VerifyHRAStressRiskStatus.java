...
public class VerifyHRAStressRiskStatus extends BaseTest{

	@Test(dataProviderClass=DataProviderFile.class, dataProvider="MyHRARisk_Stress")
...
if(data.get("Runmode").equalsIgnoreCase("N")){
	...
	/*	 if(!data.get(h.Q38).equalsIgnoreCase("Never Smoked")){
		...
		wp.clickOnStress();
		String actual =	wp.getRiskStatus("Stress");
