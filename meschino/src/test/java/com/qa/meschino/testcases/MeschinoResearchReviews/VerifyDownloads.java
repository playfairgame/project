...
public class VerifyDownloads extends BaseTest{

	
	
	@Test(dataProviderClass=DataProviderFile.class, dataProvider="MeschinoResearchReviews_Downloads")		
	public void downloads(Hashtable<String,String> data) throws InterruptedException, IOException{
