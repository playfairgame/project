...
public class VerifyHRABloodPressureUnknownRiskStatus extends BaseTest{
	...
	@Test(dataProviderClass=DataProviderFile.class, dataProvider="MyHRALogsMaleRisk_BloodPressureUnknown")
	public void HraMaleBloodPressureUnknownRiskStatus(Hashtable<String, String> data) throws InterruptedException, IOException{
...
wp.clickOnBloodPressureKnown();
String actual =	wp.getRiskStatus("Blood Pressure Reading");
