...
public class VerifyHRAMaleBloodPressureRiskStatus extends BaseTest{

	
	
	
	@Test(dataProviderClass=DataProviderFile.class, dataProvider="MyHRALogsMaleRisk_BloodPressure")
	public void HraMaleBloodPressureRiskStatus(Hashtable<String, String> data) throws InterruptedException, IOException{
